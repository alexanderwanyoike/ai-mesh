...
Use it with a job ID printed by 'ai-mesh --no-wait'.`,
	Example: `  ai-mesh fetch fal 019f095f-8728-76d2-9005-2cd19f32a143 -o hero.glb`,
...
func runFetch(name, jobID string) error {
	...
	resp, err := p.Fetch(context.Background(), key, jobID)
	if err != nil {
		return err
	}
